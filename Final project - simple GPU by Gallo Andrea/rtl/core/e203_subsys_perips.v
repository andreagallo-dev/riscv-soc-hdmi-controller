...
*/
  ...
  sirv_hclkgen_regs u_sirv_hclkgen_regs(
    ...
    ICB_bus u_ICB_bus(
      .clk               (clk),
      .rst_n             (rst_n),
      .GPU_icb_cmd_valid (my_periph_icb_cmd_valid),
      .GPU_icb_cmd_ready (my_periph_icb_cmd_ready),
      .GPU_icb_cmd_addr  (my_periph_icb_cmd_addr ),
      .GPU_icb_cmd_read  (my_periph_icb_cmd_read ),
      .GPU_icb_cmd_wdata (my_periph_icb_cmd_wdata),

      .GPU_icb_rsp_valid (my_periph_icb_rsp_valid),
      .GPU_icb_rsp_ready (my_periph_icb_rsp_ready),
      .GPU_icb_rsp_rdata (my_periph_icb_rsp_rdata), 

      .GPU_io_interrupts_0_0 (my_irq),                
